...
class Launcher extends StatelessWidget { //}with HelpWidget {
  Launcher({@required this.translation});
...
//  final GlobalKey _listKey = GlobalObjectKey("list");
  ...
  final IntlLauncher translation;
...
//              (presentation as ManagePresentation).newScreen();
  ...
  Widget buildViews(AsyncSnapshot<LauncherModel> snapshot) {
      ...
      builder: (context, orientation) {
        if (orientation == Orientation.portrait) {
          return Padding(
            ...
            child: Column(
              children: <Widget>[
                ServerLogin(snapshot.data, translation),
