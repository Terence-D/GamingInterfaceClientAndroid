...
class IntlAbout {
  static Map<String, Map<AboutText, String>> localizedStrings = {
    'en': {
      ...
      AboutText.flutterDevText: 'shared_preferences, device_info, package_info, url_launcher, path_provider developed by the Flutter Dev team and licensed under the BSD license',
      AboutText.flutterDevUrl: 'https://github.com/flutter/plugins/blob/master/packages/shared_preferences/shared_preferences/LICENSE',
      AboutText.httpTitle: 'http Package by the Dart Dev team',
      AboutText.httpText: 'Licensed under the BSD license',
      AboutText.httpUrl: 'https://github.com/dart-lang/http/blob/master/LICENSE',
      ...
      AboutText.fluttertoastUrl: 'https://github.com/PonnamKarthik/FlutterToast/blob/master/LICENSE',
      AboutText.introductionScreenTitle: 'introduction_screen by jeancharles.msse@gmail.com',
      AboutText.introductionScreenText: 'Licensed under the MIT license',
      AboutText.introductionScreenUrl: 'https://github.com/pyozer/introduction_screen/blob/master/LICENSE',
      AboutText.flutterEmailSenderTitle: 'flutter email sender by tautvydas.sidlauskas@gmail.com',
      AboutText.flutterEmailSenderText: 'LIcensed under the Apache 2.0 license',
      AboutText.flutterEmailSenderUrl: 'https://github.com/sidlatau/flutter_email_sender',
      AboutText.flutterCommunityTitle: 'Flutter Community Dev Packages',
      AboutText.flutterCommunityText: 'get_it, rxdart developed by the Flutter Community Dev Team under the MIT license',
      AboutText.flutterCommunityUrl: 'https://github.com/fluttercommunity/get_it/blob/master/LICENSE',
      AboutText.flutterLinkifyTitle: 'flutter_linkify by cretezy.com',
      AboutText.flutterLinkifyText: 'Licensed under the MIT license',
      AboutText.flutterLinkifyUrl: 'https://github.com/Cretezy/flutter_linkify/blob/master/LICENSE',
      AboutText.archiveTitle: 'archive by brendanduncan@gmail.com and kevmoo@google.com',
      AboutText.archiveText: 'Licensed under the Apache 2.0 license',
      AboutText.archiveUrl: 'https://github.com/brendan-duncan/archive/blob/master/LICENSE',
      AboutText.scrollablePositionedListTitle: 'scrollable_positioned_list by Google Dev team',
      AboutText.scrollablePositionedListText: 'Licensed under the BSD license',
      AboutText.scrollablePositionedListUrl: 'https://github.com/google/flutter.widgets/blob/master/LICENSE',
      ...
      AboutText.permissionHandlerUrl: 'https://github.com/Baseflow/flutter-permission-handler/blob/master/LICENSE',
