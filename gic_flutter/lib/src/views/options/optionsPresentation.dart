...
class OptionsPresentation implements BasePresentation {
  ...
  OptionsPresentation(BaseState contract) {
  ...
  Future<void> buildVM(BuildContext context) async {
    ...
    _viewModel.toolbarTitle = Intl.of(context).options(OptionsText.toolbarTitle);
    _viewModel.darkModeTitle = Intl.of(context).options(OptionsText.darkModeTitle);
    _viewModel.darkModelText = Intl.of(context).options(OptionsText.darkModeText);
    ...
    _viewModel.vibrationTitle = Intl.of(context).options(OptionsText.vibrationTitle);
    _viewModel.vibrationText = Intl.of(context).options(OptionsText.vibrationText);
